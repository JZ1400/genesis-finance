/* Overview / Dashboard screen — chart-led layout */
const { useState: useStateOv, useMemo: useMemoOv } = React;

function OverviewScreen({ onOpenTxn, onAddTxn, range, setRange, openAccount }) {
  const d = window.DATA;
  ...
  return (
    <div className="screen">
      ...
      {/* HERO: Net worth chart (8) + slim KPI stack (4) */}
        ...
        <div className="span-8">
          <Card thick>
            ...
            <div style={{ padding: "20px 12px 12px" }}>
              <AreaChart
                labels={labels12}
                series={[{ name: "Net worth", data: d.netWorth, primary: true }]}
                height={300}
              />
            </div>
          </Card>
      ...
      {/* Categories (span 8) + Insights (span 4) */}
      <div className="grid cols-12">
        <div className="span-8">
          <Card>
            <div className="cardhead">
            ...
            <div className="cardbody">
              <BarPairs
                rows={catRows.map(c => ({ label: c.name, a: c.thisMonth, b: c.prevMonth }))}
                height={240}
              />
            </div>
          </Card>
