...
window.DATA = (function () {
  ...
  // 12 months of monthly aggregates, ending current month (May 2026)
  ...
  // Transactions (most recent first). Mix of debit/credit, savings/cards.
  const transactions = [
    ...
    // Older — to feed 'last cycle' analytics
  ...
  // Per-account 12-month balance history (matches `months`).
  // For credit accounts these are utilization balances (positive numbers representing what's owed).
  ...
  // generate sparkline series for each (24 points, normalized 0..1 then absolute)
